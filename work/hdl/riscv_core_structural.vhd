...
--
-- Created:
--          by - docienri.student (paulchen.Informatik.tu-cottbus.de)
--          at - 02:22:56 12/30/20
--
-- Generated by Mentor Graphics' HDL Designer(TM) 2020.1 Built on 20 Jan 2020 at 19:35:24
--
LIBRARY ieee;
...
BEGIN
   ...
   u_0combo_proc: PROCESS(dout3, dout5, o_jal)
   BEGIN
      CASE o_jal IS
      WHEN '0' => dout <= dout3;
      WHEN '1' => dout <= dout5;
   ...
   BEGIN
      CASE o_mem2reg IS
      WHEN '0' => dout5 <= o_data_addr_internal;
      WHEN '1' => dout5 <= i_data_data;
